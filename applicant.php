...
<body>
    ...
    <main class="dash-content">
        ...
        <br>
        <span><h4>Welcome!!  <?php echo "<b>" . $_SESSION["admin"] .'   <i class="fas fa-smile-wink"></i>' . "</b>"?></h4> <br> This is the applicant dashboard. 
                            ...
                            <div class="stats stats-primary">
                                ...
                                <div class="stats-content">
                                    ...
                                    <div class="stats-data">
                                        <h5 id="applied-candidates"><?php echo $_SESSION['candidates'] . "<span> Candidates</span>" ?></h5>
                        ...
                        <div class="col-xl-6">
                            <div class="stats stats-success ">
                                ...
                                <div class="stats-content">
                                    ...
                                    <div class="stats-data">
                                    <h5 id="revenue-generated"><?php echo $_SESSION['candidates'] * 2000 . "<span> Naira</span>" ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
