                        ...
                        <div class="col-xl-12">
                            <div class="card spur-card">
                                <div class="card-header">
                                    ...
                                    <div class="spur-card-title"> Client Registration</div>
                                    <div class="spur-card-menu">
                                        
                                    </div>
                                </div>
                                <div class="card-body spur-card-body-chart">
                                    <form action="client_connect.php" method="post" enctype="multipart/form-data">
                                    <label for="fname"><b>Name:</b></label>
                                    <input  type="text" class="form-control"   id="fname" name="name" autocomplete="on" placeholder="Example: John" required aria-required="true">
                                    <br>
                                    ...
                                    <input  type="text" class="form-control"   id="generate" name="username"  required aria-required="true">
                                    <br>
                                    <span class="btn btn-info" onclick="generateID()">Generate Username</span>
                                    <br>
                                    <br>
                                    <label for="agreementfile"><b>Contract agreement:</b></label>
                                    <input  type="file" class="form-control"   id="agreementfile" name="agreementfile" required aria-required="true">
                                    <br>
                                    <label for="agreementfile"><b>Deployment Letter:</b></label>
                                    <input  type="file" class="form-control"   id="deploymentfile" name="deploymentfile" required aria-required="true">
                                    <br>
                                    <label for="contractfile"><b>Request Form:</b></label>
                                    <input  type="file" class="form-control"   id="contractfile" name="contractfile" required aria-required="true">
                                    <br>
                                    <label for="guards"><b>Number of Guards:</b></label>
                                    <input  type="text" class="form-control"   id="guards" name="guards" autocomplete="on" placeholder="Enter number of Guards" required aria-required="true">
                                    <br>
                                    <label class="form-label" for="address"><b>Client Address:</b></label>
