...
$password = $_REQUEST["password"];
  ...
  $sql = "SELECT * FROM employee_panel WHERE username = '$username' AND phonenumber = '$password' limit 1 ";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-ygbV9kiqUc6oa4msXn9868pTtWMgiQaeYH7/t7LECLbyPA2x65Kgf80OJFdroafW" crossorigin="anonymous"></script>              
  ...
  <div class="sticky">
      ...
      <div class="content-main">
          <h1 class="header">Login as an Employee</h1>
          <hr class="line">
          <div class="header-1">
          ...
          <div class="content-container">
              <div class="content-image">
                  <img class="image-login" src="./assets/img/Ouriginal_Header_Element-1.png" alt="Woman working">
              </div>
              <br>
              <br>
              <div class="content-signup">
                  ...
                  <form action="employee-login.php" method="POST">
                      <div class="wrapper">
                          ...
                          <input type="text"  
                          title="login with a valid User ID" class="form-control" id="userid" 
                          autocomplete="on"  placeholder="e.g MESSL2456" name="userid"  required aria-required="true">
                          <?php
                         ...
                         <div class="input-container">
                          <input type="password"  class="form-control" name="password" id="password"  autocomplete="on" placeholder="Your password is your phone number"
                           required>
                         </div>
