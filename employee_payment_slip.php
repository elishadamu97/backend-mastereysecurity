...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    ...
    $sql = "SELECT * FROM employee_form WHERE username  = '$username' ";
...
<body>
    ...
    <main class="dash-content">
        ...
        <span><h4>Payment Slip       <i class="fas fa-money-bill-alt"></i></b></h4> <br> <h5>This is where you can check your payment slips and date it was sent.</h5> </span>
        <hr>
        <br>
                <div class="container-fluid">
                <br>
                
                <h2 style="color: green">Payment Slips</h2>
                <br>
                <?php
                if(mysqli_num_rows($result_payment) > 0){
                    while($row_payment = mysqli_fetch_assoc($result_payment)){
             ?>
            <embed src="./uploaded-file/<?php echo $row_payment['payment_slip']; ?>" width="50%" height="auto" />
            <br>
            <br>
            <h4 style="color: grey;">Date of Payment: <h5 style="color: blue;"> <?php echo $row_payment['date_sent']; ?></h5></h4>  
            <hr>
